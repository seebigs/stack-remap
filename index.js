...
stackRemap.add = function add (mappings) {
    if (Array.isArray(mappings)) {
        mapCache = mapCache.concat(mappings);
    }

    return stackRemap;
};

stackRemap.reset = function reset () {
    mapCache = [];
    return stackRemap;
};

stackRemap.install = function install (mappings) {
...
stackRemap.uninstall = function uninstall () {
    Error.prepareStackTrace = void 0;
    return stackRemap;
};

module.exports = stackRemap;
